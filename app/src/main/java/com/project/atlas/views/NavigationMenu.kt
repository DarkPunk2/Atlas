...
fun NavigationMenu(navController: NavController, indexSelected: Int){
    ...
    val selectedIcons = listOf(Icons.Filled.Home,Icons.Filled.LocationOn, Icons.Sharp.DirectionsCarFilled, Icons.Filled.Map)
    val unselectedIcons =
        listOf(Icons.Outlined.Home, Icons.Outlined.Place, Icons.Outlined.DirectionsCarFilled, Icons.Outlined.Map)
